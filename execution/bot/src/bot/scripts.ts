...
export const SCRIPTS = {
  ...
  PICK_TIME: (date: string) => `Отлично! Выберите время ${date}:`,

  CONFIRM_BOOKING: (date: string, time: string) =>
    `Подтвердите запись:\n\n📅 ${date}\n🕐 ${time} (по Таллину)\n\nВсё верно?`,

  CREATING_ZOOM: '⏳ Создаём Zoom-встречу...',

  BOOKING_SUCCESS: (date: string, time: string, zoomLink: string) =>
  ...
  ERROR_GENERIC:
    `Что-то пошло не так. Попробуйте /start или напишите менеджеру: ${ML}`,
}
